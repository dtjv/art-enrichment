var flatten        = require('js-utils').flatten;
var trim           = require('js-utils').trim;
var Config         = require('./config');
var Browser        = require('./globals/browser');
var FormApp        = require('./globals/form');
...
UpdateApp._processConfig = function (cfg) {
  ...
  srcValues = trim(flatten(srcValues));
